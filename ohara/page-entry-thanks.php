                ...
                <div class="p-thanks__inner l-inner">
                    <div class="p-thanks__title">
                        <hgroup class="c-singleTitle">
                            ...
                            <h2 class="c-singleTitle__main ">応募が完了しました</h2>
                        </hgroup>
                    </div>
                    <p class="p-thanks__text c-text"> 応募をいただきありがとうございます。<br> 確認のためお客様へ自動返信メールをお送りさせて頂きました。<br> 担当者からの折り返しのご連絡をさせて頂きますので、<br> 今しばらくお待ちくださいませ。 </p>
